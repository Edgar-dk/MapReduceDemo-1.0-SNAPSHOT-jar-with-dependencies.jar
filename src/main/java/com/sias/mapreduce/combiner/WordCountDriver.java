...
public class WordCountDriver {
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        *    输入的路径里面的文件，表示计算这个文件
        *    输出的文件，表示计算完成存放文件的位置*/
        FileInputFormat.setInputPaths(instance,new Path("D:\\User1\\rundata\\document\\major\\UnderASophomore\\Test\\inputword"));
        FileOutputFormat.setOutputPath(instance,new Path("D:\\User1\\rundata\\document\\major\\UnderASophomore\\Test\\output1"));
        /*07.提交job*/
